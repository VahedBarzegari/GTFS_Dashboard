...
from GTFS_core_data import routes_df, agency_df, stops_df, stop_times_df, calendar_df, calendar_dates_df, shapes_df, trips_df,shape_route_df, route_type_df,route_df1
    ...
    with ui.layout_columns(col_widths=(5, 7), height='900px'):
        with ui.card():
            ...
            with ui.card():
                ...
                ui.input_date("date", "", min='2024-11-17', max='2024-12-22')  
